...
public class InstallerGui extends JFrame implements InstallerProgress {
    ...
    protected String buildEditorPaneStyle(boolean error) {
        JLabel label = new JLabel();
        if (error) label.setForeground(Color.RED);
    ...
    private void showInstalledMessage() {
        if (success) {
            JEditorPane pane = new JEditorPane("text/html", "<html><body style=\"" + buildEditorPaneStyle(false) + "\">" + buildSuccessfulTest() + "</body></html>");
